...
!(function ($) {
  ...
  function Plugin(action, options) {
    ...
    return this.each(function () {
      ...
      data ||
        ((data = new Accordion($this, $.extend(!0, {}, options))),
  ...
  ((Accordion = function ($element, options) {
        ...
        typeof (action =
          ...
          (action =
            "string" != typeof action
              ? $this.data("vcAction") || this.getContainer().data("vcAction")
              : action)
            ? Accordion.DEFAULT_TYPE
            : action) && Plugin.call($this, action, options);
    }),
      ...
      var that = this,
        ...
        getTarget = function () {
          ...
          return (element = element.length
            ? element
            : that.getContainer().filter(selector));
        };
      return this.isCacheUsed()
        ? (void 0 === this.$target && (this.$target = getTarget()),
          this.$target)
        : getTarget();
    }),
    (Accordion.prototype.getTargetContent = function () {
      ...
      return this.isCacheUsed()
        ? (void 0 === this.$targetContent &&
            (($targetContent = $target).data("vcContent") &&
        ...
        : $target.data("vcContent") &&
          ($targetContent = $target.find($target.data("vcContent"))).length
        ? $targetContent
        : $target;
    }),
    ...
    (Accordion.prototype.triggerEvent = function (event, opt) {
      "string" == typeof event &&
        ((event = $.Event(event)), this.$element.trigger(event, opt));
    }),
    ...
    (Accordion.prototype.changeLocationHash = function () {
      var id,
        $target = this.getTarget();
      (id = $target.length ? $target.attr("id") : id) &&
        (history.pushState
    ...
    (Accordion.prototype.getAnimationDuration = function () {
      var that = this,
        findAnimationDuration = function () {
          return void 0 === Accordion.transitionName
            ? "0s"
            : that.getTargetContent().css("transition-duration").split(",")[0];
        };
      return this.isCacheUsed()
        ? (void 0 === this.animationDuration &&
        ...
        (-1 <
          (activeIndex =
            ...
            ($activeTriggers = $activeTriggers
              ...
              .vcAccordion()
              .data("vc.accordion")) &&
            $activeTriggers.getIndex
              ? $activeTriggers.getIndex()
              : activeIndex) && activeIndex + 1 < $triggers.length
      ...
      $triggers.length &&
        ($activeTriggers.length &&
          ($activeTriggers = $activeTriggers
            ...
            .data("vc.accordion")) &&
          $activeTriggers.getIndex &&
          (activeIndex = $activeTriggers.getIndex()),
        Plugin.call(
          -1 < activeIndex
            ? 0 <= activeIndex - 1
    ...
    (Accordion.prototype.scrollToActive = function (opt) {
      ...
      (void 0 === opt || void 0 === opt.scrollTo || opt.scrollTo) &&
        (0, ($targetElement = $((that = this).getTarget())).length) &&
        this.$element.length &&
        setTimeout(function () {
          $targetElement.offset().top -
            ...
            $("html, body").animate(
              {
                scrollTop:
                  $targetElement.offset().top - +that.$element.outerHeight(),
              },
              300
            );
        }, 300);
    ...
    (hashNavigation = function () {
      ...
      hash &&
        ($targetElement = $(hash)).length &&
        (hash = $targetElement.find(
        ...
        (setTimeout(function () {
          $("html, body").animate(
            {
              scrollTop: $targetElement.offset().top - 0.2 * $(window).height(),
            },
            0
          );
        }, 300),
