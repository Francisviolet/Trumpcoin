(function ($) {
  ...
  // OnePage Scrolling
  $(
    '.navbar a[href*="#"]:not([href="#"]), .scroll[href*="#"]:not([href="#"])'
  ).on("click", function () {
    if (
  ...
  if ($count_token.length > 0) {
    $count_token.each(function () {
      var $self = $(this),
        ...
        tzone = $self.attr("data-zone");
      var $days = $self.attr("data-days"),
        $hours = $self.attr("data-hours"),
        $mins = $self.attr("data-mins"),
        $secs = $self.attr("data-secs");
      var $day = $self.attr("data-day"),
        $hour = $self.attr("data-hour"),
  ...
  var slider_p = ".slider-pane",
    slider_n = ".slider-nav,.slider-dot";
  ...
  if ($body_m.hasClass("io-zinnia")) {
    ($particles_color = "#fff"), ($particles_color_alt = "#fff");
  }
  ...
  //Mask Section
  $(".io-azure .intro-section").append(
    '<div class="mask-ov-left mask-ov-s1"></div>'
  );
  $(".io-azure .why-choose").append(
    '<div class="mask-ov-right mask-ov-s2"></div>'
  );
  $(".io-azure .token-section").append(
    '<div class="mask-ov-left mask-ov-s3"></div>'
  );
  $(".io-azure .app-section").append(
    '<div class="mask-ov-right mask-ov-s7"></div>'
  );
  $(".io-azure .team-section").append(
    '<div class="mask-ov-right mask-ov-s4"></div>'
  );
  $(".io-azure .faq-section").append(
    '<div class="mask-ov-left mask-ov-s5"></div>'
  );
  $(".io-azure .contact-section").append(
    '<div class="mask-ov-right mask-ov-s6"></div>'
  );

  $(".icos-overlay").append(
    '<div class="overlay-bars"><div class="overlay-bar-1"></div><div class="overlay-bar-2"></div><div class="overlay-bar-3"></div><div class="overlay-bar-4"></div><div class="overlay-bar-5"></div><div class="overlay-bar-6"></div><div class="overlay-bar-7"></div></div>'
  );
  $(".banner-jasmine").prepend('<div class="background-shape"></div>');
  $(".banner-lungwort").prepend(
  ...
  $(".io-zinnia .banner .banner-rounded-bg")
    .removeClass("banner-rounded-bg")
    .addClass("ui-shape ui-shape-light ui-shape-header");
  $(".io-zinnia .shape-s1 .banner-rounded-bg")
    .removeClass("banner-rounded-bg")
    .addClass("ui-shape ui-shape-s1");
  $(".io-zinnia .shape-s2 .banner-rounded-bg")
    .removeClass("banner-rounded-bg")
    .addClass("ui-shape ui-shape-s2");
  $(".io-zinnia .shape-s3 .banner-rounded-bg")
    .removeClass("banner-rounded-bg")
    .addClass("ui-shape ui-shape-s3");
  $(".io-zinnia .shape-s4 .banner-rounded-bg")
    .removeClass("banner-rounded-bg")
    .addClass("ui-shape ui-shape-s4");
  $(".io-zinnia .shape-s5 .banner-rounded-bg")
    .removeClass("banner-rounded-bg")
    .addClass("ui-shape ui-shape-s5");
  $(".io-zinnia .shape-s6 .banner-rounded-bg")
    .removeClass("banner-rounded-bg")
    .addClass("ui-shape ui-shape-s6");
  $(".io-zinnia .shape-s7 .banner-rounded-bg")
    .removeClass("banner-rounded-bg")
    .addClass("ui-shape ui-shape-s7");
